    ...
    def price_compute(self, price_type, uom=False, currency=False, company=None):
        ...
        if kits:
            ...
            if price_type == "standard_price":
                ...
                # Thus, in order to compute the sale price from the cost for users
                # not in this group
            ...
            for product in products:
                if product.kit_product_ids:
                    prices[product.id] = (
                        sum(product.sudo().kit_product_ids.mapped("product_price"))
                        or 0.0
                    )
                else:
            ...
            return super(ProductProduct, no_kits).price_compute(
